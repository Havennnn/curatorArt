...
const History = () => {
  return (
    <section className="bg-base w-full py-10 px-32 relative -z-30">
      ...
      <div class="absolute lg:w-[600px] lg:h-[600px] rounded-full border-[8px] border-white/90 shadow-[0_0_20px_5px_rgba(255,255,255,0.8)] right-64 top-20 -z-20"></div>
      <div className="px-10 text-white flex gap-14">
        ...
        <div className="p-10 flex flex-col w-4/5 gap-10">
