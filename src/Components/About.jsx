      ...
      <div className="align-element grid md:grid-cols-2 items-center gap-16 pointer-events-none">
        ...
        <article>
          ...
          <p className="text-black mt-8 leading-loose">
            I am committed to creating visually appealing and user-friendly
            digital experiences. My expertise spans across modern web
            technologies, including HTML5, CSS3, JavaScript, and popular
            frameworks like React and Tailwind. Additionally, I’m also skilled
            in server-side technologies like Node.js.
          </p>
        </article>
      </div>
    </section>
